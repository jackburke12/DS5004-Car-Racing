...
class DuelingDQNAgent(BaseAgent):
    def __init__(
        self,
        replay_size=150000,
        batch_size=32,          # your original file uses smaller batch size
        gamma=0.99,
        lr=1e-4,
        eps_start=1.0,
        eps_end=0.05,
        eps_decay_steps=500000,
        in_channels=3,          # your dueling agent uses NUM_STACK = 3
        img_h=84,
        img_w=84,
        device=None,
    ):
